...
**Date:** 2026-07-21  
**Agent:** Marvin  
**Marvin dive:** `ABNB/research/deep_dive_2026-07-21.md`  
**Source inventory:** `ABNB/third-party-analyses/source_inventory_2026-07-10.md`  
**Framework:** `_system/frameworks/third_party_cross_reference.md`, `external_view_blend.md`

## Executive summary

Marvin floor **14.1%** per year (platform; stance **watch**) from primary filings and `valuation.json`. Proof-first component schedule base **$145.82/sh** vs price **~$146.89**. No third-party sources indexed; filings-only stance. **[HUMAN REVIEW]** for approved-source numeric blend.
...
|-------|------------------|----------|--------|
| Base return anchor | **14.1%** per year | Qualitative support only | `ABNB/research/deep_dive_2026-07-21.md` |
| Component base value | **$145.82/sh** | No external anchor | `ABNB/research/valuation.json` |
| Archetype / stance | **platform** · **watch** | See indexed sources | `valuation.json` |
| Normalization | Owner cash uses company-reported FCF | Cross-check vs posts | Marvin |
...
|------|-------------------|------------------|-------------|
| Marvin floor | Component schedule **$145.82/sh** | **14.1%** | **watch** |
...
1. `ABNB/research/deep_dive_2026-07-21.md`
2. `ABNB/research/valuation.json`
3. `ABNB/research/evidence_reconciliation_2026-07-21.md`
4. `ABNB/third-party-analyses/source_inventory_2026-07-10.md`
