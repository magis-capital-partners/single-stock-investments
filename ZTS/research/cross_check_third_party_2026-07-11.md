...
**Marvin dive:** `ZTS/research/deep_dive_2026-07-11.md`
**Source inventory:** `ZTS/third-party-analyses/source_inventory_2026-07-11.md`
...
|-------|------------------|----------|--------|
| Base return anchor | **17.18%** per year | Qualitative support only | `ZTS/research/deep_dive_2026-07-11.md` |
...
- [PROPOSED COMPANY] ZTS: third-party cross-check fill 2026-07-11 — Marvin 17.18% unchanged

## Primary sources cited

1. `ZTS/research/deep_dive_2026-07-11.md`
2. `ZTS/research/valuation.json`
3. `ZTS/third-party-analyses/source_inventory_2026-07-11.md`
