...
**Dive reviewed:** `AMCR/research/deep_dive_2026-07-23.md`  
**Valuation reviewed:** `AMCR/research/valuation.json`  
**Filings used:** `AMCR/research/evidence/filing_facts_2026-07-23.json`
...
|-------|---------------------------|---------------|-----|
| Returns statement | 3.01% | 3.01% | Yes |
| Classification IRR | 3.01% | 3.01% | Yes |
| Valuation bridge base | 3.01% | 3.01% | Yes |
