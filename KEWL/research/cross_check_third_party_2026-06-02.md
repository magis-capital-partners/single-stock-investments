...
**Marvin dive:** `KEWL/research/deep_dive_2026-06-02.md`
...
|-------|--------------|----------|-------------|
| Primary IRR | **-8.29%** (Lawrence / scenarios) | No single approved IRR unless promoted | Marvin **70%** numeric; external **30%** catalyst timing |
...
|------|-------------------|------------------|-------------|
| Marvin floor | See assumption ledger | **-8.29%** | **watch** |
| External (combined) | Narrative / catalyst | No change to base % | **watch** (conviction) |
| **Blended best estimate** | **Filing anchor** | **-8.29%** | **watch** |
...
**Returns statement (blended):** We expect **-8.29%** per year at today's price on the Marvin base case; third-party sources may raise or lower conviction on timing but do not replace filing math without **[HUMAN REVIEW]**.
...
- [PROPOSED COMPANY] KEWL: third-party cross-check fill 2026-06-02 — Marvin -8.29% unchanged

## Primary sources cited

1. `KEWL/research/deep_dive_2026-06-02.md`
2. `KEWL/research/valuation.json`
3. `KEWL/third-party-analyses/source_inventory_2026-06-02.md`
