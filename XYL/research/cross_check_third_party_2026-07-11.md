...
**Marvin dive:** `XYL/research/deep_dive_2026-07-11.md`
**Source inventory:** `XYL/third-party-analyses/source_inventory_2026-07-11.md`
...
|-------|------------------|----------|--------|
| Base return anchor | **-0.3%** per year | Qualitative support only | `XYL/research/deep_dive_2026-07-11.md` |
...
- [PROPOSED COMPANY] XYL: third-party cross-check fill 2026-07-11 — Marvin -0.3% unchanged; no new filings since 2026-07-10

## Primary sources cited

1. `XYL/research/deep_dive_2026-07-11.md`
2. `XYL/research/valuation.json`
3. `XYL/third-party-analyses/source_inventory_2026-07-11.md`
