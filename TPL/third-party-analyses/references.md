# TPL — Third-party references

| Source | Date | URL | Use in Marvin work |
|--------|------|-----|-------------------|
| Portfolio Update (GTX, MSB, FRMO, TPL) | ~2024 | https://specialsituationinvesting.substack.com/p/portfolio-update-gtx-msb-frmo-tpl | **Approved (SSI)** — Permian water tailwinds; context only, not in base IRR |
