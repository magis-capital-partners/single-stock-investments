...
**Marvin dive:** `ABT/research/deep_dive_2026-07-10.md`
**Source inventory:** `ABT/third-party-analyses/source_inventory_2026-07-10.md`
**Framework:** `_system/frameworks/third_party_cross_reference.md`, `external_view_blend.md`

## Executive summary

Marvin floor **12.24%** per year (compounder; stance **watch**) from primary filings and `valuation.json`. No third-party sources indexed; filings-only stance. **[HUMAN REVIEW]** for approved-source numeric blend.
...
|-------|------------------|----------|--------|
| Base return anchor | **12.24%** per year | Qualitative support only | `ABT/research/deep_dive_2026-07-10.md` |
| Archetype / stance | **compounder** · **watch** | See indexed sources | `valuation.json` |
| Normalization | FY2024 net income inflated by one-time items; base uses operating cash flow not  | Cross-check vs posts | Marvin |
...
|------|-------------------|------------------|-------------|
| Marvin floor | See assumption ledger | **12.24%** | **watch** |
...
- [PROPOSED COMPANY] ABT: third-party cross-check fill 2026-07-10 — Marvin 12.24% unchanged

## Primary sources cited

1. `ABT/research/deep_dive_2026-07-10.md`
2. `ABT/research/valuation.json`
3. `ABT/third-party-analyses/source_inventory_2026-07-10.md`
