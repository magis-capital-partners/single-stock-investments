...
| `groundbreaker` | Groundbreaker RE (Substack) | BWEL, LB, TPL, WBI | `approved_substacks.md` | **2026-06-02** (human: yes — water-rights lens; context tier for unverified acre-foot NAV until filings) |
