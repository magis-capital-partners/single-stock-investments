...
**Dive reviewed:** `GOOGL/research/deep_dive_2026-07-21.md`  
**Valuation reviewed:** `GOOGL/research/valuation.json`  
**Filings used:** `GOOGL/research/evidence/filing_facts_2026-07-21.json`
...
| Classification IRR | -0.97% | -1.47% | **No** |
| Valuation bridge base | -0.97% | -0.97% | Yes |

**Lint notes:**
- GOOGL/research/deep_dive_2026-07-21.md: executive_summary_first_pct -1.5% vs valuation.json base -0.97% (tol 0.25pp)
